...
function updateBrowserRecord(record) {
...
const browserFallbackApi = {
  ...
  checkOut(now = /* @__PURE__ */ new Date()) {
    const state = readBrowserState();
    const date = localDateKey(now);
    const existing = state.records.find((record) => record.date === date);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: `app-frame ${isCompact ? "app-frame-compact" : ""}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: `app-window ${isCompact ? "app-window-compact" : ""}`, children: isCompact ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "custom-titlebar", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "titlebar-brand", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "WorkShift Tracker" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "window-controls", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(IconMinus, { size: 16 })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "window-titlebar", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "window-kicker", children: "WorkShift Tracker" }),
      ...
      screen === "home" && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: `status-pill status-${status}`, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", {}),
        statusLabel(status)
      ] }),
      screen === "history" && /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "toolbar-button", type: "button", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(IconTableExport, { size: 17 }),
        "Excel"
      ] }),
      screen === "settings" && /* @__PURE__ */ jsxRuntimeExports.jsx(IconSettings, { className: "title-icon", size: 22 })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "screen-tabs", "aria-label": "Primary screens", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(IconHome, { size: 17 }),
            "Home"
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(IconHistory, { size: 17 }),
            "Log"
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(IconSettings, { size: 17 }),
            "Settings"
          ]
        }
      )
    ] }),
    screen === "home" && /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "screen-content", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "date-clock", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: format(now, "EEEE, dd MMMM yyyy") }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: format(now, "HH:mm:ss") })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "tray-row", "aria-label": "System tray indicator colors", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("i", { className: "tray-dot tray-red" }),
          " Idle"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("i", { className: "tray-dot tray-yellow" }),
          " Working"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("i", { className: "tray-dot tray-green" }),
          " Done"
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "progress-block", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "progress-track", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "progress-fill", style: { width: `${progressPercent}%` } }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "info-card-grid", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "info-card", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Check-in" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: checkInLabel })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "info-card", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Est. end" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: estimatedEnd })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "info-card", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Today total" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: formatDuration(elapsed) })
        ] })
      ] }),
      todayRecord?.checkOutAt && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "shift-log-card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "shift-log-heading", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(IconTimelineEvent, { size: 16 }),
            "Today's shift log"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: formatDuration(elapsed) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "shift-log-times", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(IconLogin2, { size: 15 }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "In" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: checkInLabel })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("i", { "aria-hidden": "true" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(IconLogout2, { size: 15 }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Out" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: format(new Date(todayRecord.checkOutAt), "HH:mm") })
          ] })
        ] }),
